...
PathPlannerConfig PathPlannerConfig::FromFile(const char* pp_file, const char* map_file) {
  ...
  PathPlannerConfig config = {
      ...
      .trajectory_layer_queue_len = config_json["trajectory_layer_queue_len"].get<size_t>(),
      ...
      .front_car_buffer_m = config_json["front_car_buffer_m"].get<double>(),
      .back_car_buffer_m = config_json["back_car_buffer_m"].get<double>(),
